...
import com.microservicio.rutas.repositories.TarifaRepository;
...
public class TarifaService {
    ...
    public Tarifa crear(TarifaDTO dto) {
        ...
        tarifa.setFechaActualizacion(System.currentTimeMillis());
    ...
    public void inicializarTarifasDefecto() {
        ...
        if (tarifaRepository.count() == 0) {
            ...
            crearTarifaDefecto("ESTADIA_DEPOSITO", "Costo de estadía en depósito por día", new BigDecimal("50.00"),
                    "dia");
