-- 🔹 Datos de prueba para estados de solicitud
...
-- 3 → completada
-- 4 → cancelada
INSERT INTO solicitud (id_contenedor, id_cliente, costo_estimado, tiempo_estimado, costo_final, tiempo_real, id_tarifa, id_estado, id_ruta) VALUES
                                                                                                                                       (101, 201, 5000.00, 5, 5100.00, 6, 1, 3, 0),  -- completada
                                                                                                                                       (102, 202, 4500.00, 4, 4700.00, 5, 2, 3, 0),  -- completada
                                                                                                                                       (103, 203, 6000.00, 6, NULL, NULL, 3, 1, 1),  -- pendiente
                                                                                                                                       (104, 201, 7000.00, 7, 6900.00, 7, 1, 3, 2),  -- completada
                                                                                                                                       (105, 204, 4000.00, 4, 4100.00, 3, 2, 4, 3),  -- cancelada
                                                                                                                                       (NULL, 205, 5200.00, 5, NULL, NULL, 3, 1, 3), -- pendiente
                                                                                                                                       (NULL, 206, 4800.00, 4, NULL, NULL, 2, 1, 3), -- pendiente
